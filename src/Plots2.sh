...
declare -a list_tools=("coronaSPAdes" "Haploflow" "IRMA" "LAZYPIPE" "metaSPAdes" "metaviralSPAdes" "PEHaplo" "QuRe" "QVG" "SPAdes" "SSAKE" "TRACESPipe" "TRACESPipeLite" "VirGenA" "ViSpA" "V-pipe")
#declare -a list
#declare -p list
#
rm -rf vir
...
for tool in "${TOOLS[@]}" 
  ...
  declare -a DATASETS=("66" "67" "68" "69")
  printf "" > $tool
...
for tool in "${TOOLS[@]}" 
  ...
  declare -a DATASETS=( "70" "71" "72" "73")
  printf "" > $tool
...
gnuplot << EOF
    reset
    set terminal pdfcairo enhanced color font 'Verdade,9'
    set output "Identity_5x_error.pdf"
    set datafile separator "\t"
    ...
    set xrange [-0.2:3.2]
    set key outside right top
    set xtics ("0.0" 0, "0.01" 1, "0.025" 2, "0.05" 3)
    set ytics auto
    set ylabel "Identity"
...
gnuplot << EOF
    reset
    set terminal pdfcairo enhanced color font 'Verdade,9'
    set output "Recon_bases_5x_error.pdf"
    set datafile separator "\t"
...
gnuplot << EOF
    reset
    set terminal pdfcairo enhanced color font 'Verdade,9'
    set output "Min_scaffold_5x_error.pdf"
    set datafile separator "\t"
...
gnuplot << EOF
    reset
    set terminal pdfcairo enhanced color font 'Verdade,9'
    set output "Max_scaffold_5x_error.pdf"
    set datafile separator "\t"
...
gnuplot << EOF
    reset
    set terminal pdfcairo enhanced color font 'Verdade,9'
    set output "Avg_scaffold_5x_error.pdf"
    set datafile separator "\t"
...
gnuplot << EOF
    reset
    set terminal pdfcairo enhanced color font 'Verdade,9'
    set output "Recon_bases_wout_n_5x_error.pdf"
    set datafile separator "\t"
...
gnuplot << EOF
    reset
    set terminal pdfcairo enhanced color font 'Verdade,9'
    set output "Min_scaffold_wout_n_5x_error.pdf"
    set datafile separator "\t"
...
gnuplot << EOF
    reset
    set terminal pdfcairo enhanced color font 'Verdade,9'
    set output "Max_scaffold_wout_n_5x_error.pdf"
    set datafile separator "\t"
...
gnuplot << EOF
    reset
    set terminal pdfcairo enhanced color font 'Verdade,9'
    set output "Avg_scaffold_wout_n_5x_error.pdf"
    set datafile separator "\t"
...
gnuplot << EOF
    reset
    set terminal pdfcairo enhanced color font 'Verdade,9'
    set output "ratio_snps_5x_error.pdf"
    set datafile separator "\t"
...
gnuplot << EOF
    reset
    set terminal pdfcairo enhanced color font 'Verdade,9'
    set output "ratio_snps_wout_n_5x_error.pdf"
    set datafile separator "\t"
...
gnuplot << EOF
    reset
    set terminal pdfcairo enhanced color font 'Verdade,9'
    set output "Identity_40x_error.pdf"
    set datafile separator "\t"
...
gnuplot << EOF
    reset
    set terminal pdfcairo enhanced color font 'Verdade,9'
    set output "Recon_bases_40x_error.pdf"
    set datafile separator "\t"
...
gnuplot << EOF
    reset
    set terminal pdfcairo enhanced color font 'Verdade,9'
    set output "Min_scaffold_40x_error.pdf"
    set datafile separator "\t"
...
gnuplot << EOF
    reset
    set terminal pdfcairo enhanced color font 'Verdade,9'
    set output "Max_scaffold_40x_error.pdf"
    set datafile separator "\t"
...
gnuplot << EOF
    reset
    set terminal pdfcairo enhanced color font 'Verdade,9'
    set output "Avg_scaffold_40x_error.pdf"
    set datafile separator "\t"
...
gnuplot << EOF
    reset
    set terminal pdfcairo enhanced color font 'Verdade,9'
    set output "Recon_bases_wout_n_40x_error.pdf"
    set datafile separator "\t"
...
gnuplot << EOF
    reset
    set terminal pdfcairo enhanced color font 'Verdade,9'
    set output "Min_scaffold_wout_n_40x_error.pdf"
    set datafile separator "\t"
...
gnuplot << EOF
    reset
    set terminal pdfcairo enhanced color font 'Verdade,9'
    set output "Max_scaffold_wout_n_40x_error.pdf"
    set datafile separator "\t"
...
gnuplot << EOF
    reset
    set terminal pdfcairo enhanced color font 'Verdade,9'
    set output "Avg_scaffold_wout_n_40x_error.pdf"
    set datafile separator "\t"
...
gnuplot << EOF
    reset
    set terminal pdfcairo enhanced color font 'Verdade,9'
    set output "ratio_snps_40x_error.pdf"
    set datafile separator "\t"
...
gnuplot << EOF
    reset
    set terminal pdfcairo enhanced color font 'Verdade,9'
    set output "ratio_snps_wout_n_40x_error.pdf"
    set datafile separator "\t"
