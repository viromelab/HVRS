...
#
gto_fasta_mutate -s 0 -e 0.01 < VZV.fa > VZV_1.fa
gto_fasta_mutate -s 0 -e 0.03 < VZV.fa > VZV_2.fa
gto_fasta_mutate -s 0 -e 0.05 < VZV.fa > VZV_3.fa
#
#
# CREATE DATASETS:
#
cat SVA_1.fa B19_1.fa HPV_1.fa VZV_1.fa > DS1.fa
cat SVA_2.fa B19_2.fa HPV_2.fa VZV_2.fa > DS2.fa
cat SVA_3.fa B19_3.fa HPV_3.fa VZV_3.fa > DS3.fa
#
#
