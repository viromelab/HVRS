...
#
gto_fasta_mutate -s 4 -e 0.01 < HPV.fa > HPV-1.fa
gto_fasta_mutate -s 5 -e 0.03 < HPV.fa > HPV-2.fa
gto_fasta_mutate -s 6 -e 0.05 < HPV.fa > HPV-3.fa
#
gto_fasta_mutate -s 7 -e 0.01 < VZV.fa > VZV-1.fa
gto_fasta_mutate -s 8 -e 0.03 < VZV.fa > VZV-2.fa
gto_fasta_mutate -s 9 -e 0.05 < VZV.fa > VZV-3.fa
#
#
# CREATE DATASETS:
#
